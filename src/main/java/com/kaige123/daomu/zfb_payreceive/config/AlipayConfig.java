package com.kaige123.daomu.zfb_payreceive.config;
...
//↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
    ...
    public static String merchant_private_key = "XxORpgN42ZRLntpoexYvYQ==";
    ...
    public static String notify_url = "http://daomu.kaige123.daomu/zfb_publicpayreceive/notify_url.jsp";
